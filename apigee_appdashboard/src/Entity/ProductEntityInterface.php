 ...
 */
interface ProductEntityInterface extends ContentEntityInterface, RevisionLogInterface, EntityChangedInterface, EntityOwnerInterface {
   ...
   *   The Product name.
   *
   * @return \Drupal\apigee_appdashboard\Entity\ProductEntityInterface
